...
namespace mm { namespace allocator
{
    ...
    inline Block *Block::allocateBlock(BlocksHolder *thisBlockHolder, std::size_t sizeClass)
    {
        ...
        if(!vm::protect(ptr, SizeLayout::_blockSize, true))
        {
            std::abort();
        }
    ...
    inline Block::Block(BlocksHolder *thisBlockHolder, std::size_t sizeClass)
        ...
        , _elementsAmount{(SizeLayout::_blockSize - offsetof(Block, _elementsArea)) / sizeClass}
    {
        const std::size_t elementsAmount = (SizeLayout::_blockSize - offsetof(Block, _elementsArea)) / _sizeClass;
    ...
    inline void Block::freeWithoutCounters(void *ptr)
    {
        ...
        assert(reinterpret_cast<std::size_t>(_nextFreeElement) < reinterpret_cast<std::size_t>(this) + SizeLayout::_blockSize);
    }
    ...
    template <std::size_t sizeClass> void *Block::alloc()
    {
        ...
        {
            std::size_t elementsAmount = (SizeLayout::_blockSize - offsetof(Block, _elementsArea)) / sizeClass;
