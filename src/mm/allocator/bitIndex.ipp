...
namespace mm { namespace allocator
{
    ...
    {
        vm::protect(this, SizeLayout::_pageSize, true);
        _header._protectedSize = SizeLayout::_pageSize;
    }
    ...
    bitIndex::Address BitIndex<volume>::allocate()
    {
        ...
        if(unlikely(SizeLayout::_blocksAmount == addr))
        {
    ...
    void BitIndex<volume>::updateProtection(void *addr)
    {
        ...
        std::size_t protectedSize = (static_cast<char *>(addr) - utils::sized_cast<char *>(this)) / SizeLayout::_pageSize * SizeLayout::_pageSize + SizeLayout::_pageSize*2;
        ...
        else if(protectedSize < _header._protectedSize - SizeLayout::_pageSize)
        {
            if(!vm::protect(
